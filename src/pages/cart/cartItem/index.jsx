                    ...
                    <CartItemContainer>
                            {
                                this.props.set ? <i
                                    onClick={
                                        this.props.goodsSelect.bind(this, item.item.main_item[0].product_sku_id)}
                                    className={
                                        willCollect.includes(item.item.main_item[0].product_sku_id) ? "active iconfont" : "iconfont"
                                    }

                                >&#xe626;</i> : <i
                                    onClick={
                                        this.props.select.bind(this, { objects: [{ sku_id: item.item.main_item[0].product_sku_id, is_checked: !item.item.main_item[0].is_checked }] })}
                                    className={
                            ...
                            <div className="cart--item-img" >
                                <img src={item.item.main_item[0].cover_image} alt="" />
                            </div>
                            <div className="cart--item-desc">
                                <p>{item.item.main_item[0].title}</p>
                                <div className="cart--select">
                                    <p>{item.item.main_item[0].spec_str}</p>
                                ...
                                <div className="cart--bottom">
                                    <div className="cart--price">
                                        <span>￥</span>
                                        <span>{item.item.main_item[0].price}</span>
                                    </div>
                                    <Count count={item.item.main_item[0].quantity} changeCount={this.props.changeCount.bind(this, item.item.product_sku_id)}></Count>
                                </div>
                            </div>
